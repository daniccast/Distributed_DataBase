...
select      to_char(TO_DATE('4-Ene-2021 7:00 Am','dd-Mon-yyyy hh:mi am'), 'DL') FECHA
			from dual;
select      to_char(TO_DATE('4-Abr-2020 7:00 Am','dd-Mon-yyyy hh:mi am'), 'J') FECHA
			from dual;
...
select      to_char(TO_DATE('01-Ene--4712 7:00 Am','dd-Mon-sYYYY hh:mi am'), 'J') FECHANU
			from dual;
select      to_char(TO_DATE('01-Ene--4712 7:00 Am','dd-Mon-sYYYY  hh:mi am'), 'DL') FECHANU
			from dual;			
select      to_char(TO_DATE('01-Ene-1 7:00 Am','dd-Mon-sYYYY hh:mi am'), 'J') FECHANU
			from dual;
