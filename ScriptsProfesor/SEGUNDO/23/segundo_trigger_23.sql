SPOOL C:\Users\lolol_000\Documents\Distributed_DataBase\ScriptsProfesor\SEGUNDO\23\mi_segundo_trigger.txt
...
CREATE TABLE TEMPORAL5 (N NUMBER, M NUMBER DEFAULT 5);

*/
REM 6.5 Example Row Triggers 
...
CREATE OR REPLACE TRIGGER temp_aiudr2
AFTER INSERT OR UPDATE OR DELETE ON TEMPORAL5
FOR EACH ROW
BEGIN
    CASE
...
DROP TRIGGER temp_aiudr2;
DROP TRIGGER temp_biudr;
DROP TRIGGER temp_adr;
DROP TRIGGER temp5_aiur;
DROP TRIGGER temp_aiudr;
DROP TRIGGER temp_biudr2;
DROP TRIGGER temp_adr2;
...
create table professors (
 ...
 INSERT INTO PROFESSORS values ('CARLOS', 'Ancient Hist',to_date('04-08-99','DD-MM-YY'),45000,'YES','MATE');
...
REM
 INSERT INTO PROFESSORS values ('JUAN', 'Hist Euro',to_date('05-08-00','DD-MM-YY'),1000,'YES','MATH');
 INSERT INTO PROFESSORS values ('JUAN', 'Hist Euro',to_date('05-08-00','DD-MM-YY'),1000,'YES','MATE');
 INSERT INTO PROFESSORS values ('CARLOS', 'Antig Hist',to_date('04-08-99','DD-MM-YY'),1000,'YES','MATH');
