spool C:\Users\ORA_bases\2021_02_24_clase_2\salida\arbol_heuris2.txt
...
rem contar el numero de tuplas que se generan en el prod cartesiano 
rem   de employee & works_on
...
select * 
	from vistad1,vistab0
	where essn = ssn;
	
drop view vistad2;
create view vistad2 as
select * 
	from vistad1,vistab0
	where essn = ssn;
...
-------------------------------
rem inciso E
select pnumber,essn,pno
	from project, works_on
	where pnumber=pno
	and pname ='ProductY';  
	
rem solo el atributo indispensable
select essn
	from project, works_on
	where pnumber=pno
	and pname ='ProductY'; 
DROP view VISTae1;	
create view vistaE1 as
select essn
	from project, works_on
	where pnumber=pno
	and pname ='ProductY';  
