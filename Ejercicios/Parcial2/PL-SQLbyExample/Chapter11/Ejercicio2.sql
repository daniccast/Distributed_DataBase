...
/*
Este ejemplo muestra la infromación de los estudiantes y el número de cursos a los que 
están inscritos.
Nos apoyamos de un cursor. Otra forma de implementar el código es usando un FOR para
cursores.
*/
